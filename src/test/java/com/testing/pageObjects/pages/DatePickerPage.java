...
public class DatePickerPage extends WidgetsPage{
  // Locators ----------------------------------------------------------------------------------------------------------
  public static By DATE_PICKER_TITLE = text("Text Box");
  public static By SELECT_DATE = id("datePickerMonthYearInput");
  public static By SELECT_DATE_AND_TIME = id("dateAndTimePickerInput");
